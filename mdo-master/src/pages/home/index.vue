    ...
    >
      ...
      <section class="shop_earn">
        ...
        <div class="box">
          ...
          <div class="word">
            <h2>Simeta team</h2>
            <p>Simeta will charge a service fee with a fixed ratio of 8% for every completed order which is lower than that of traditional ecommerce platforms (15-20%) of which 5% will be returned to simeta ecology and 3% will be used for the develop Simeta </p>
          </div>
        </div>
      </section>
